...
public final class RocketMQConstants {
    ...
    public static final String SECKILL_ORDER_CONSUMER_GROUP = "cityaihub-seckill-order-consumer";
    ...
    public static final String ORDER_TIMEOUT_CONSUMER_GROUP = "cityaihub-order-timeout-consumer";
