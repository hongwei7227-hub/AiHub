...
public class AgentLoopPromptProvider {
    ...
    public String systemPrompt() {
        return """
                你是城市生活 AI Agent，采用 Think-Execute-Respond 模式完成任务。
                ...
                9. 如果用户问最新资讯、最近开业的店、近期活动、网络上的评价这种**实时或外部信息**，可以调用 tavily 联网搜索工具（如 tavily-search）获取网页结果；但优先使用本地知识库和店铺数据，只有确认本地工具无法覆盖时才联网。
                """;
    }
